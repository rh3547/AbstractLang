...
TT_ELSEIF           = 'ELSEIF'              # Else If
TS_ELSEIF           = '?'                   # Else If Symbol
...
class Lexer:
    ...
    def make_tokens(self):
        ...
        while self.current_char != None:
            ...
            # Alternate "then"
            elif self.current_char == TS_THEN:
    ...
    def make_identifier(self):
        ...
        # If the keyword is the IF keyword, return as TT_IF
        elif id_str == KEY_IF:
            return Token(TT_IF, pos_start=pos_start, pos_end=self.pos)

        # If the keyword is the THEN keyword, return as TT_THEN
        elif id_str == KEY_THEN:
            return Token(TT_THEN, pos_start=pos_start, pos_end=self.pos)

        # If the keyword is the ELSEIF keyword, return as TT_ELSEIF
        elif id_str == KEY_ELSEIF:
            return Token(TT_ELSEIF, pos_start=pos_start, pos_end=self.pos)

        # If the keyword is the ELSE keyword, return as TT_ELSE
        elif id_str == KEY_ELSE:
            return Token(TT_ELSE, pos_start=pos_start, pos_end=self.pos)
...
class Parser:
    ...
    def if_expression(self):
        ...
        if not self.current_token.type == TT_IF:
            return res.failure(InvalidSyntaxError(self.current_token.pos_start, self.current_token.pos_end, f'Expected "{KEY_IF}"'))
        ...
        if not self.current_token.type == TT_THEN:
            return res.failure(InvalidSyntaxError(self.current_token.pos_start, self.current_token.pos_end, f'Expected "{KEY_THEN}"'))
        ...
        while self.current_token.type == TT_ELSEIF:
            res.register_advancement()
            self.advance()
